...
if ( $has_footer_menu || $has_social_menu || $has_sidebar_1 || $has_sidebar_2 ) {
	...
	<div class="footer-nav-widgets-wrapper header-footer-group" style="background-color: <?php the_field('footer_background_color', 'option') ?>; color: <?php the_field('footer_text_color', 'option'); ?>">
