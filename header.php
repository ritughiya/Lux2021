...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?> style="background-color: <?php the_field('footer_background_color', 'option'); ?>">
		...
		wp_body_open();
		?>
		<header id="site-header" class="newHeader header-footer-group" role="banner">
			...
			<div class="header-inner section-inner ">
				...
				<div class="header-marquee-container">
								...
								<a href="<?php the_field('callout_link', 'option') ?>" class="submit">
								<span><?php the_field('callout_marquee', 'option') ?> </span>
								</a></p></div>
							...
							<div class="toggle-wrapper nav-toggle-wrapper has-expanded-menu">
								...
								<button class="toggle nav-toggle desktop-nav-toggle" data-toggle-target=".menu-modal" data-toggle-body-class="showing-menu-modal" aria-expanded="false" data-set-focus=".close-nav-toggle">
									<span class="toggle-inner">
											...
											<span class="toggle-text" style=" color:#0000FF;"><?php _e( 'Menu', 'twentytwenty' ); ?></span>
