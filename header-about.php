...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?> style="background-color: <?php the_field('footer_background_color', 'option'); ?>">
		...
		wp_body_open();
		?>
		<header style="background-color: #E5E5E5 !important; ?>" id="site-header" class="newHeader header-footer-group" role="banner">
...
<main id="site-content" role="main" style="background-color: #E5E5E5; ?>">
